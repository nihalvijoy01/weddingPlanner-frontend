        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
              <span className="ms-3">
                Wedding Dashboard for {wedding.venue}
              </span>
            </div>
            <div class="flex items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
              <p>
...
{
  /* <div>
        <button onClick={() => navigate(`/wedding/${weddingId}/guests`)}>
          Manage Guests
        </button>
        <button onClick={() => navigate(`/wedding/${weddingId}/checklist`)}>
          Manage Checklist
        </button>
        <button onClick={() => navigate(`/wedding/${weddingId}/budget`)}>
          Manage Budget
        </button>
        <button onClick={() => navigate(`/wedding/${weddingId}/vendors`)}>
          Manage Vendors
        </button>
      </div> */
}
